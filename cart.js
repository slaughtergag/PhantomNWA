...
(function () {
    ...
    async function checkoutCart(btnEl) {
        ...
        try {
            ...
            const res = await fetch(
                'https://checkout.phantomnwa.shop/create-checkout',
                {
                    method: 'POST',
                    headers: {
    ...
    function addItem(item) {
        ...
        // Notify any cart UI that the cart has changed
        window.dispatchEvent(new Event('phantom-cart-updated'));
    ...
    function showUpsellPopup(addedItem) {
        ...
        popup.innerHTML = `
            ...
            ">
                ...
                <button
                    onclick="document.getElementById('ph-upsell').remove()"
                    style="
                        background:none;
                        border:none;
                        color:#555;
            ...
            ">
                ...
                <button
                    onclick="
                        document.getElementById('ph-upsell').remove();
                        window.PhantomCart._openDrawer();
                    "
                    style="
                        flex:1;
                        font-family:'Oxanium',sans-serif;
        ...
        itemsEl.innerHTML = cart.map(item => `
            ...
            ">
                ...
                <div style="
                    ...
                    height:64px;
                    flex-shrink:0;
                    background:${item.color === 'black' ? '#e8e8e8' : '#1a1a1a'};
                ...
                ">
                    ...
                    ">
                        ...
                        <button
                            onclick="window.PhantomCart.updateQty(
                                '${item.id}',
                                '${item.color}',
                                '${item.size || ''}',
                                ${item.qty - 1}
                ...
                ">
                    ...
                    <button
                        onclick="window.PhantomCart.removeItem(
                            '${item.id}',
                            '${item.color}',
                            '${item.size || ''}'
                        )"
    ...
    function injectCartIcon() {
        ...
        if (document.getElementById('ph-cart-btn')) return;
    ...
    function init() {
        ...
        if (!document.getElementById('ph-drawer')) {
            ...
            Array.from(tmp.children).forEach(
                el => document.body.appendChild(el)
            );

            document
                .getElementById('ph-close')
                .addEventListener('click', closeDrawer);

            document
                .getElementById('ph-overlay')
                .addEventListener('click', closeDrawer);
        }
    ...
    function refreshCartUI() {
        ...
        // Update the badge directly from localStorage
